...
def get_docIds_list_from_response(json_response):
    ids = []
...
if __name__ == '__main__':
    ...
    predictions_standard_0 = get_docIds_list_from_response(
    ...
    predictions_standard_1 = get_docIds_list_from_response(
    ...
    predictions_standard_2 = get_docIds_list_from_response(search_index(input_query="What was discovered on Mars?",
                                                                        index_name="articles_10000_data"))
    ...
    predictions_standard_3 = get_docIds_list_from_response(
    ...
    predictions_standard_4 = get_docIds_list_from_response(
    ...
    predictions_standard_5 = get_docIds_list_from_response(search_index(input_query="How much does the iPad Pro cost?",
                                                                        index_name="articles_10000_data"))
    ...
    predictions_standard_6 = get_docIds_list_from_response(search_index(input_query="How many people flee to Germany?",
                                                                        index_name="articles_10000_data"))
    ...
    predictions_process_0 = get_docIds_list_from_response(
        search_index(input_query="What are the problems caused by domestic violence?",
    ...
    predictions_process_3 = get_docIds_list_from_response(
        search_index(input_query="Which artists are the headliners at Apple Music Festival?",
                     index_name="articles_10000_data"))
    ...
    predictions_process_4 = get_docIds_list_from_response(
        search_index(input_query="Which country launched its first space observatory into space?",
                     index_name="articles_10000_data"))
    ...
    predictions_100_standard_1 = get_docIds_list_from_response(
    ...
    predictions_100_process_1 = get_docIds_list_from_response(
        search_index(input_query="How many people flee to Germany?",
                     index_name="processed_100_data"))
    ...
    predictions_100_vector_1 = get_docIds_list_from_response(
